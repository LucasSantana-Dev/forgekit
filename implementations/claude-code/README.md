...
use the same model as your main session. Route them to Haiku in `~/.claude/settings.json`:
...
[CCR](https://github.com/musistudio/claude-code-router) routes Claude Code requests to different
models by slot type.
