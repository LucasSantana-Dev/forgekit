...
- agents
source:
  path: ai-dev-toolkit/packages/core/patterns/benchmark-reality-gap.md
  license: MIT
translations:
  pt-BR:
...
See [`packages/core/patterns/agent-evals-ci.md`](./agent-evals-ci.md) for integrating these evals into your CI pipeline and automating regression detection.
...
- [`packages/core/patterns/agent-evals-ci.md`](./agent-evals-ci.md) — integrating these evals into CI; regression detection; per-skill scoring
- [`packages/core/patterns/agent-observability.md`](./agent-observability.md) — instrumenting the agent to understand where queries fail
- [`packages/core/patterns/prompting-discipline.md`](./prompting-discipline.md) — prompt patterns that improve real-world task success
- [`packages/core/best-practices/ai-skill-stewardship.md`](../packages/core/best-practices/ai-skill-stewardship.md) — human-in-the-loop frameworks that complement agent autonomy
