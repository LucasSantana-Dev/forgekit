...
- [`packages/core/kit/core/skills/plan.md`](../packages/core/kit/core/skills/plan.md) — planning skill that enforces explicit phases + verification steps
- [`packages/core/best-practices/ai-skill-stewardship.md`](../packages/core/best-practices/ai-skill-stewardship.md) — keeping the human half of the pair sharp
