...
```
DEP SWEEP — <repo>
  Enumerated:    18 bot PRs
  Auto-merged:   12 into release (devDeps + patches)
  For review:    4 (next 14.2→14.3, eslint 9.0→9.1, ...)
  Held:          2 (react v19 major, prisma v6 major)
  Changelog:     1 batched line added under [Unreleased]
  Nudge:         release is now 7 commits ahead of main — consider /release-cut
```
