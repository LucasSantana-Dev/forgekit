...
| [Codex CLI](https://github.com/openai/codex)                                        | AI coding agent           | Sandbox-first terminal agent (OpenAI). Conservative baseline is read-only with approvals; many teams switch to `workspace-write` for active development                                              |
