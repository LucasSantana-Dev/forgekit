...
echo "Run: python3 scripts/sync-toolkit-version.py --prepare-pr  # draft the next toolkit bump PR summary"
echo "Run: python3 scripts/sync-toolkit-version.py --prepare-pr --pr-body-file TOOLKIT_BUMP_PR.md"
