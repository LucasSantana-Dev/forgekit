...
export const SHELL: Record<Locale, Record<string, string>> = {
  ...
  "pt-br": {
    ...
    "usage.title": "Uso",
    "usage.useWhen": "Use quando",
    "usage.skipWhen": "Evite quando",
    "usage.prereqs": "Pré-requisitos",
    "usage.resources": "Recursos",
    "usage.meta.difficulty": "Instalação",
    "usage.meta.setup": "Setup",
    "usage.difficulty.easy": "Fácil",
    "usage.difficulty.medium": "Médio",
    "usage.difficulty.hard": "Difícil",
    "usage.setup.seconds": "Segundos",
    "usage.setup.minutes": "Minutos",
    "usage.setup.hours": "Horas",
    "usage.res.ram": "RAM",
    "usage.res.storage": "Armazenamento",
    "usage.res.compute": "Processamento",
    "usage.res.network": "Rede",
    "usage.res.cost": "Custo",
    "usage.compute.cpu-light": "CPU · leve",
    "usage.compute.cpu-moderate": "CPU · moderada",
    "usage.compute.cpu-heavy": "CPU · pesada",
    "usage.compute.gpu-optional": "GPU · opcional",
    "usage.compute.gpu-required": "GPU · obrigatória",
    "usage.network.offline": "Offline",
    "usage.network.online": "Online",
    "usage.network.online-optional": "Online · opcional",
    "usage.cost.free": "Grátis",
    "usage.cost.paid-optional": "Pago · opcional",
    "usage.cost.paid-required": "Pago",
    "usage.cost.metered-api": "API por uso",
