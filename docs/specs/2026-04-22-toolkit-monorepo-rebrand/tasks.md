...
- [ ] Decide final product/repo name (`forge-kit` recommended)
...
- [ ] Update docs and package metadata for Forge Kit naming
- [ ] Run full verification across core, setup, catalog, CLI, web, and docs
