...
kind: agent
tier: opus
role: Ultrathink Debugger — deep reasoning for gnarly bugs, 3+ level traces
trigger: |
  - Complex bugs resisting normal debugging
  - User requests: "ultradebug this" or "deep dive"
  - Multi-layer interactions (async, race conditions, state machine)
  - Subtle timing or concurrency issues
created: 2026-04-15
---
