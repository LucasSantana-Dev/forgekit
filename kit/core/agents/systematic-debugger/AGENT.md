...
kind: agent
tier: sonnet
role: Systematic Debugger — evidence-driven root cause analysis, hypothesis testing
trigger: |
  - User requests: "debug this" or "why is this failing"
  - When a bug report includes reproduction steps
  - Before proposing a fix, understand the root cause
  - On test failures or runtime errors
created: 2026-04-15
---
