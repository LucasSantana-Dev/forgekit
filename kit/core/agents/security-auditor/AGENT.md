...
kind: agent
tier: sonnet
role: Security Auditor — OWASP checks, dependency scanning, secrets detection, threat paths
trigger: |
  - Before merge or release
  - User requests: "security audit" or "check for secrets"
  - On security branches or PRs marked security-related
